#!/usr/bin/env python3
# Adapted from https://github.com/mikf/gallery-dl/blob/master/test/test_results.py
...
from gallery_dl import config, exception, formatter, job, util
...
# --------------------------------------------------------------------
# Replace everything below when `test_results.py`` is updated upstream
# Also replace
#   `if cls.__module__.startswith("gallery_dl.extractor."):`
# with
#   `if cls.__module__.startswith("extractor."):`
# below
